                            ...
                            <table cellPadding="0" cellSpacing="0" style={{ verticalAlign: '-webkit-baseline-middle', display: 'inline-block', fontSize: 'medium', fontFamily: 'Arial' }}>
                              <tbody>
                                <tr style={{ textAlign: 'center' }}>
                                  <td width="24">
                                    <a href="" target="_blank" style={{ display: 'inline-block', padding: '0px', backgroundColor: '#6D7FE2' }}>
                                      <img
                                        height="24"
                                        width="24"
                    ...
                    <table cellPadding="0" cellSpacing="0" style={{ verticalAlign: '-webkit-baseline-middle', fontSize: 'medium', fontFamily: 'Arial', textAlign: 'left' }}>
                      <tbody>
                        ...
                        <tr height="24" style={{ verticalAlign: 'middle' }}>
                          ...
                          <td>
                            <a id="website_url" target="_blank" href="" style={{ textDecoration: 'none', color: 'rgb(0, 0, 0)', fontSize: '12px', lineHeight: '20px' }}>
